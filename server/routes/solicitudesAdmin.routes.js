// solicitudesAdmin.routes.js — v5
// Cambios: cambiarEstatus y transferir pasan loginSolicitante/nombre al service
"use strict";
...
router.put("/solicitudes/:id/escalar", verifyToken, ctrl.escalar);
router.post(
